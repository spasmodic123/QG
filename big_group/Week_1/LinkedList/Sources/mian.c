...
extern LinkedList;
extern LNode;
extern LinkedList head_one_way = NULL;
extern LinkedList_two_way head_two_way = NULL;
extern LinkedList loop_head=NULL;

int main()
{
	 head_one_way = (LinkedList)malloc(sizeof(LNode)); // 单向链表的头指针
	 head_two_way = (LinkedList_two_way)malloc(sizeof(LNode_two_way));//双向链表头指针
	 loop_head = (LinkedList)malloc(sizeof(LNode));//成环链表头指针
	...
	while (1)
	{
		...
		printf(">>> 2.创建双向链表.               \n");
		printf(">>> 3.销毁单向链表.           \n");
		printf(">>> 4.往单向链表加入元素(666).              \n");
		printf(">>> 5.查找单向链表里是否有元素(9).              \n");
		printf(">>> 6.删除单向链表的元素(8).              \n");
		printf(">>> 7.遍历单向链表.             \n");
		printf(">>> 8.遍历双向链表.    \n");
		printf(">>> 9.反转单向链表(  递归  ).       \n");
		printf(">>> 10.反转单向链表(  迭代  )         \n");
		...
		case 8:
			...
			break;
		case 9:
			head_one_way=reverse_list_recur(head_one_way);
			break;
		case 10:
			head_one_way=reverse_list_interation(head_one_way);
			printf("\n反转成功!");
			system("pause");
			break;
		case 11:
